...
const QString BITCOIN_IPC_PREFIX("k-coin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click k-coin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start k-coin: click-to-pay handler");
    else
...
{
    // clicking on k-coin: URLs creates FileOpen events on the Mac:
